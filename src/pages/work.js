              ...
              <div style={{ display: "flex", marginBottom: 20 }}>
                <div style={styles.workItem}>
                  ...
                  <img
                    ...
                    onClick={() =>
                      window.open(
                        "https://www.blocumenta.org/blockathonsyd2019"
                      )
                    }
                  />
                  <div style={{ margin: 20 }}>
                    <h4 style={{ textAlign: "center", fontSize: 24 }}>
                      {" "}
                      Blocumenta Blockathon
                    </h4>
                    <p style={{ textAlign: "center", fontSize: 18 }}>
                      {" "}
                      Wireframed, designed and implementated of landing page for
                      a Blockchain Hackathon page.
                    </p>
                    <ul
                      style={{
                        display: "flex",
                ...
                <div style={{ display: "flex", marginBottom: 20 }}>
                  <div style={styles.workItem}>
                    ...
                    <div style={{ margin: 20 }}>
                      ...
                      <p style={{ textAlign: "center", fontSize: 18 }}>
                        {" "}
                        Wireframed and contributed to front-end development.
          ...
          <div style={styles.container}>
            <div style={{ display: "flex", marginBottom: 20 }}>
              <div style={styles.workItem}>
                ...
                <div style={{ margin: 20 }}>
                  <h4 style={{ textAlign: "center", fontSize: 24 }}> bitfwd</h4>
                  <p style={{ textAlign: "center", fontSize: 18 }}>
                    {" "}
                    Designed and built website over Wordpress
                  </p>
                  <ul
                    style={{
                      display: "flex",
            ...
            <div style={{ display: "flex", marginBottom: 20 }}>
              <div style={styles.workItem}>
                ...
                <div style={{ margin: 20 }}>
                  ...
                  <p style={{ textAlign: "center", fontSize: 18 }}>
                    {" "}
                    Designed and built website over SquareSpace.
                  </p>
                  <ul
                    style={{
                      display: "flex",
